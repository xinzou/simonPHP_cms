...
/* admin/article/edit.twig */
class __TwigTemplate_f4deb03463f29e87e4230efc9e2f7aec96ba93fa03d6b524669bef74c196b873 extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 1
        $this->parent = $this->loadTemplate("admin/layouts/master.twig", "admin/article/edit.twig", 1);
        $this->blocks = array(
    ...
    public function block_content($context, array $blocks = array())
    {
        ...
        <div class=\"row\">
            ...
            ";
        // line 8
        $this->loadTemplate("admin/layouts/left.twig", "admin/article/edit.twig", 8)->display($context);
        // line 9
        echo "                    <!-- content -->
            <div class=\"col-md-10\">
                <div class=\"row\">
        ...
        // line 26
        echo twig_escape_filter($this->env, $this->env->getExtension('slim')->site("admin/article/update"), "html", null, true);
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["category"]) {
            ...
            echo "\" ";
            if (($this->getAttribute($context["category"], "id", array()) == $this->getAttribute((isset($context["article"]) ? $context["article"] : null), "cate_id", array()))) {
                echo " selected ";
            }
            echo ">";
...
";
    ...
    {
        return "admin/article/edit.twig";
    }
    ...
    {
        return array (  158 => 83,  150 => 78,  131 => 62,  114 => 48,  106 => 42,  91 => 40,  87 => 39,  77 => 32,  70 => 28,  65 => 26,  46 => 9,  44 => 8,  38 => 4,  35 => 3,  29 => 2,  11 => 1,);
    }
}
...
/*                             </div>*/
/*                             <div class="bootstrap-admin-no-table-panel-content bootstrap-admin-panel-content collapse in">*/
/*                                 <form class="form-horizontal" action="{{ siteUrl('admin/article/update') }}" method="post" enctype="multipart/form-data">*/
/*                                     <fieldset>*/
...
/*                                                         <option value="{{category.id}}" {% if category.id == article.cate_id %} selected {% endif %}>{{category.cate_name}}</option>*/
/*                                                     {% endfor %}*/
/*                                                 </select>*/
/*                                             </div>*/
/*                                         </div>*/
...
/*                                             <label class="col-lg-2 control-label" for="tags">标签</label>*/
/*                                             <div class="col-lg-8">*/
/*                                                 <input class="form-control" id="tags" name="tags" type="text" value='{{article.tags}}'>*/
/*                                             </div>*/
/*                                             <p class="text-info">可以设置多个标签，请以“,”间隔。如：a,b</p>*/
/*                                         </div>*/
/*                                         <div class="form-group">*/
